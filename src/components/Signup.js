  ...
  return(   
    ...
    <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
      ...
      <div className="  bg-gray-300 bg-opacity-40 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
        ...
        <h2 className="text-gray-900 text-lg font-medium title-font mb-5">Sign Up to Code Embers</h2>
        ...
        <button onClick={submit} class="bg-black hover:bg-gray-500 transition-colors duration-200 text-white py-2 px-8 focus:outline-none rounded text-lg">Signup</button>

      </div>

    </div>
    <h1 class="mb-10 font-extrabold text-2xl text-white">OR</h1>
    <Link to = "/" className="bg-transparent hover:bg-white transition-colors duration-200 text-white hover:text-white text-2xl font-bold py-2 px-4 rounded ">Login</Link>
    </div>
  </section>
